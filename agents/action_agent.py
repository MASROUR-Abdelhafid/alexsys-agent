...
# Ajout du Negative Prompting pour bloquer le format XML natif de Llama 3.1
...
CONTRAINTE ABSOLUE : Tu dois invoquer les outils en utilisant le format JSON standard attendu par l'API. NE GÉNÈRE JAMAIS de balises XML comme <function=nom_outil>. N'écris pas le mot "function" entre chevrons."""
